...
public class EventDetailsView {
    ...
    @Bind(R.id.eventTime)
    TextView eventTime;
    @Bind(R.id.venueSection)
    LinearLayout venueSection;
    @Bind(R.id.venueName)
    TextView venueName;
    ...
    @Bind(R.id.map)
    ImageView map;
    @Bind(R.id.venueAccessSection)
    LinearLayout venueAccessSection;
    @Bind(R.id.venueAccessInfo)
    TextView venueAccessInfo;
    @Bind(R.id.eventDetails)
